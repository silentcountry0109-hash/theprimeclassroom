...
import { Lock, User, ArrowLeft, Mail, UserPlus, Phone, MapPin, CheckCircle2, Eye, EyeOff, ShieldCheck, Smartphone } from "lucide-react";
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="flex flex-col items-center text-center gap-2" data-testid="step-phone-verify">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5 leading-snug">輸入簡訊驗證碼</p>
                </div>
              </div>
            </div>
