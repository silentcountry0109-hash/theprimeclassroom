    ...
    await db.insert(faqs).values([
      {
        ...
        answer:
          "我們採用一對一至一對五的小班制個別指導模式。每位教練在同一時段最多指導 5 位學生，每位學生都有獨立的學習進度和教材，教練會依據每位學生的狀態給予個別指導。",
        category: "關於課程",
        sortOrder: 1,
        isActive: true,
      },
      ...
      },
      {
        question: "可以先試聽嗎？",
        answer:
          "當然可以！我們提供免費的適性診斷課程，讓教練了解孩子的學習狀態，同時也讓孩子體驗我們的教學方式。請透過首頁的預約功能來安排試聽。",
        category: "關於課程",
        sortOrder: 3,
        isActive: true,
      },
      ...
      },
      {
        question: "教練的資格要求是什麼？",
        answer:
          "所有教練均需通過總部的嚴格培訓課程，包含教學方法、兒童心理學、認知轉譯技巧等。通過考核後才能獲得「質數數學認證教練」資格。",
        category: "關於教練",
        sortOrder: 6,
        isActive: true,
      },
      {
        question: "可以更換教練嗎？",
        answer:
          "可以的。如果您覺得教練與孩子的學習風格不太契合，可以隨時透過平台更換到同教室的其他教練，或搜尋其他教室的教練。",
        category: "關於教練",
        sortOrder: 7,
        isActive: true,
      },
