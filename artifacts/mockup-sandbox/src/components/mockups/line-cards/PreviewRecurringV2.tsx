...
export function PreviewRecurringV2() {
  return (
        ...
        <div className="chat-area">
          <div className="bubble-row">
            ...
            <div className="flex-card">
              <div className="card-header-band" style={{ background: 'linear-gradient(135deg, #81D8D0 0%, #4fbdb4 100%)' }}>
                <div className="card-header-emoji">✅</div>
                <div className="card-header-text">
                  <div className="card-header-title">連排預約成功！</div>
                  <div className="card-header-sub">共 12 堂課程已排定</div>
                </div>
              </div>
